...
members_df = pd.read_excel("../data/2025_12_06/original/2025_12_06_Members-Data.xlsx")
...
members_df.to_csv("../data/2025_12_06/cleaned/current_members.csv", index=False)
